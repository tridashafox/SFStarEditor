...
C++ [Visual Studio 2022](https://visualstudio.microsoft.com/) project. If you don't want to install Visual Studio, you have the option of downloading a [Microsoft VM with it already installed](https://developer.microsoft.com/en-us/windows/downloads/virtual-machines/). Note if someone passes you a built version of this as a .exe then it may not run unless you have the Visual Studion runtime binaries and the zlib.dll (see below).
